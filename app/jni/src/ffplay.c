...
static int packet_queue_put(PacketQueue *q, AVPacket *pkt)
{
    ...
    //pkt isn't head and call packet_queue_put_private failure release packet inner mem
...
int main(int argc, char **argv)
{
    ...
    VideoState *is;
    SDL_Log("===> argc:%d\n",argc);
    char* argv2[2]={argv[0],"/storage/emulated/0/VisualArts/materials/083934c90444fbee72c109a8d54e204b.rmvb"};
    for(int k=0;k<2;k++){
        SDL_Log("%d->%s\n",k,argv2[k]);
    }
    argv=argv2;
